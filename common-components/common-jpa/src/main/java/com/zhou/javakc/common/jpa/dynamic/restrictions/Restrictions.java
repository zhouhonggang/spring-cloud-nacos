package com.zhou.javakc.common.jpa.dynamic.restrictions;

import com.zhou.javakc.common.jpa.dynamic.criterion.Criterion;
import com.zhou.javakc.common.jpa.dynamic.expression.JoinExpression;
import com.zhou.javakc.common.jpa.dynamic.expression.LogicalExpression;
import com.zhou.javakc.common.jpa.dynamic.expression.SimpleExpression;
...
public class Restrictions {
    ...
    /**
     * 复杂关系连接查询
     * @param fieldName1 当前查询对象 中 关联对象的 属性名称
     * @param fieldName2 查询对象 中 需要查询的 属性名称
     * @param value 属性值
     * @return 符合条件结果集
     */
    public static JoinExpression joinList(String fieldName1, String fieldName2, Object value, Criterion.Operator operator)
    {
        if(StringUtils.isEmpty(value))
        {
            return null;
        }
        return new JoinExpression(fieldName1, fieldName2, value, operator);
    }
